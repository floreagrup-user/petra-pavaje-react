  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-500">
      ...
      <motion.div
        ...
        className="bg-navy-800 text-white/80 text-sm overflow-hidden"
      >
                  ...
                  <AnimatePresence>
                    {item.children && activeDropdown === item.label && (
                      <motion.div
                        ...
                        className="absolute top-full left-0 w-screen max-w-4xl bg-white rounded-xl shadow-premium border border-warm-gray-200 p-6"
                      >
                                ...
                                <ul className="space-y-1">
                                  {child.children.slice(0, 6).map((sub) => (
                                    <li key={sub.label}>
                                      <Link
                                        to={sub.href}
                                        className="block text-xs text-warm-gray-500 hover:text-charcoal-700 transition-colors py-0.5"
                                      >
                                        {sub.label}
                                      </Link>
                                    </li>
            ...
            <div className="flex items-center gap-2">
              <button
                className={cn(
                  ...
                  isScrolled
                    ? 'text-charcoal-500 hover:bg-warm-gray-50'
                    : 'text-white/80 hover:text-white hover:bg-white/10'
                )}
              >
      ...
      <div className="flex items-center justify-between">
        <Link
          ...
          className={cn(
            ...
            depth === 0 ? 'text-charcoal-900' : 'text-charcoal-500'
          )}
        >
          {item.label}
        </Link>
        {item.children && (
          <button
            ...
            className="p-1 text-warm-gray-400"
          >
