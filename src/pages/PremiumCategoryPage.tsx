...
import { usePremiumCategorySEO } from '@/hooks/usePremiumCategorySEO'
import { PremiumProductCard } from '@/components/product/PremiumProductCard'
import { PremiumFilterPanel, ActiveFilterChips } from '@/components/product/PremiumFilterPanel'
import {
  buildPremiumFacets,
  matchesFilters,
  sortProducts,
...
export function PremiumCategoryPage() {
  ...
  const facets = useMemo(() => buildPremiumFacets(allProducts), [allProducts])
  ...
  usePremiumCategorySEO(allProducts, PREMIUM_FAQ)

  const updateFilters = (next: PremiumFilters) => {
