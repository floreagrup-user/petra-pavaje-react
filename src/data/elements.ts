...
export const elementCategories: ElementCategoryData[] = [
    ...
    variantGroups: [
      {
        ...
        variants: [
          ...
          { name: 'Bloc de beton 60×60×60', code: '—', dimensions: '60×60×60 cm', piecesPerMl: 1.66, piecesPerPallet: 500, weightKg: '—' },
        ],
      },
    ],
    documents: [
    ...
    variantGroups: [
      {
        ...
        variants: [
          { name: 'Rezervor de apă Ø 1000', code: '—', dimensions: 'Di 1000 mm, H 1000 mm, g 70 mm', weightKg: 540 },
        ],
      },
    ],
    faq: [
  ...
  // ===================== CANALIZARE: INFRASTRUCTURĂ RUTIERĂ =====================
  {
    ...
    documents: [
      { label: 'Placă rectangulară necarosabilă 1000×1000', productCode: '2040', declarationUrl: 'https://pub-5dbaf337ef004f7ca4f5287b3e8b701f.r2.dev/2040-Declaratie-performanta-Capac-necarosabil-rectangular-Rama-rectangulara-din-beton-armat-1200x1200x150-Petra-Pavaje.pdf' },
      { label: 'Placă necarosabilă + capac fontă', productCode: '2042', declarationUrl: 'https://pub-5dbaf337ef004f7ca4f5287b3e8b701f.r2.dev/2042-Declaratie-performanta-Capac-necarosabil-rectangular-Rama-rectangulara-din-beton-armat-1200x1200x150capac-Petra-Pavaje.pdf' },
      { label: 'Placă rectangulară carosabilă', productCode: '2048', declarationUrl: 'https://pub-5dbaf337ef004f7ca4f5287b3e8b701f.r2.dev/2048-Declaratie-performanta-Capac-carosabil-rectangular-Rama-rectangulara-din-beton-armat-1200x1200x200-Petra-Pavaje.pdf' },
      { label: 'Placă carosabilă + capac fontă', productCode: '2049', declarationUrl: 'https://pub-5dbaf337ef004f7ca4f5287b3e8b701f.r2.dev/2049-Declaratie-performanta-Capac-carosabil-rectangular-Rama-rectangulara-din-beton-armat-1200x1200x200capac-fonta-Petra-Pavaje.pdf' },
      { label: 'Placă carosabilă + capac fontă 5h', productCode: '2050', declarationUrl: 'https://pub-5dbaf337ef004f7ca4f5287b3e8b701f.r2.dev/2050-Declaratie-performanta-Capac-carosabil-rectangular-Rama-rectangulara-din-beton-armat-1200x1200x200capac-fonta-5h-Petra-Pavaje.pdf' },
      { label: 'Placă carosabilă + capac compozit', productCode: '2051', declarationUrl: 'https://pub-5dbaf337ef004f7ca4f5287b3e8b701f.r2.dev/2051-Declaratie-performanta-Capac-carosabil-rectangular-Rama-rectangulara-din-beton-armat-1200x1200x200capac-compozit-Petra-Pavaje.pdf' },
      { label: 'Placă carosabilă + capac compozit 5h', productCode: '2052', declarationUrl: 'https://pub-5dbaf337ef004f7ca4f5287b3e8b701f.r2.dev/2052-Declaratie-performanta-Capac-carosabil-rectangular-Rama-rectangulara-din-beton-armat-1200x1200x200capac-comp-5h-Petra-Pavaje.pdf' },
    ],
    faq: [
