    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Rigole', href: '/produse/rigole' },
          { label: 'Bolțari', href: '/produse/boltari' },
          {
            label: 'Garduri',
            href: '/produse/garduri',
            children: [
              { label: 'Robusto', href: '/produse/garduri/robusto' },
              { label: 'Modern', href: '/produse/garduri/modern' },
              { label: 'Baroc', href: '/produse/garduri/baroc' },
            ],
          },
          { label: 'Jardiniere', href: '/produse/jardiniere' },
          { label: 'Palisadă', href: '/produse/palisada' },
          { label: 'Bănci', href: '/produse/banci' },
          { label: 'Treaptă', href: '/produse/treapta' },
          { label: 'Bloc de zid', href: '/produse/bloc-de-zid' },
          {
            label: 'Elemente de canalizare',
            href: '/produse/elemente-de-canalizare',
            children: [
              { label: 'Bloc de beton', href: '/produse/elemente-de-canalizare/bloc-de-beton' },
              { label: 'Cămine 1000 mm', href: '/produse/elemente-de-canalizare/elemente-pentru-camine-1000-mm' },
              { label: 'Cămine 800 mm', href: '/produse/elemente-de-canalizare/elemente-pentru-camine-800-mm' },
              { label: 'Tub fântână', href: '/produse/elemente-de-canalizare/tub-fantana' },
              { label: 'Tuburi și timpane', href: '/produse/elemente-de-canalizare/tuburi-si-timpane' },
              { label: 'Infrastructură rutieră', href: '/produse/elemente-de-canalizare/infrastructura-rutiera' },
            ],
          },
        ],
      },
