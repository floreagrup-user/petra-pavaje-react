      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Bolțari', href: '/boltari' },
          {
            ...
            href: '/garduri-2',
            children: [
              { label: 'Robusto', href: '/garduri-2/robusto' },
              { label: 'Modern', href: '/garduri-2/modern' },
              { label: 'Baroc', href: '/garduri-2/baroc' },
            ],
          },
          { label: 'Jardiniere', href: '/jardiniere-2' },
